...
import demoImage from "../SectionOne/Group 167.webp"; // Replace with the path to your image
        ...
        <Container className="my-5 container">
            ...
            style={{marginTop:"8%"}}>
                ...
                <Col md={7} className="no-gutter right">
                    ...
                    <Image src={img4} className="overlay-image-right-two" alt="Decorative Image 1" />
